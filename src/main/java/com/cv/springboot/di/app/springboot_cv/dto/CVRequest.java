...
public class CVRequest {
    ...
    public List<TechnicalSkillRequest> getTechnicalSkills() { return technicalSkills; }
    public void setTechnicalSkills(List<TechnicalSkillRequest> technicalSkills) { this.technicalSkills = technicalSkills; }
